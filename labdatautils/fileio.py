...
def load_file(excel_file, fluc='luc2P', rluc='hrlucP'):
    """Loads TECAN exported excel file. Each excel page is assumed to be separate measurementthat is added to DataFrame
    table."""
    ...
    return pd.DataFrame({'Konstruktid': luc2p[0], 'Treatments': luc2p[1], 'fluc': luc2p[2], 'rluc': hrlucp[2]},
                        columns=['Konstruktid', 'Treatments', 'fluc', 'rluc'])
